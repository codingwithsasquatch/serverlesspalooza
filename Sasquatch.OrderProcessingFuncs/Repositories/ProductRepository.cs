...
namespace Sasquatch.OrderProcessingFuncs.Repositories
{
    internal class ProductRepository
    {
        ...
        public async Task Initialize()
        {
            ...
            var product1 = new Product() { Id = "SPROCKET-1", Count = 5, Name = "Sprocket Cleaner" };
            CreateProductDocumentIfNotExists(product1).Wait();
            var product2 = new Product() { Id = "SPROCKET-2", Count = 12, Name = "Sprocket Bag" };
